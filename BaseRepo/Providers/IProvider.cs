...
namespace BaseRepo
{
    public interface IProvider
    {
        ...
        string SelectQuery<T>(Expression<Func<T, bool>> expression, string tableName) where T : class;
        string SelectFirstQuery<T>(Expression<Func<T, bool>> expression, string tableName) where T : class;
    }
}